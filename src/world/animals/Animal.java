...
public abstract class Animal extends Organism {
    ...
    Animal(world.Point cord, world.World where, int str, int ini) {
        super(cord, where, str, ini);
    }
    ...
    Organism move(Direction dir) {
        ...
        if (world instanceof WorldHex) dir.translateHex(cords);
        else dir.translate(cords);
        return result;
    }
    ...
    void porliferation(Organism partner) {
        if (world.createInNeighbour(partner.getCords(), this.getClass())) {
            world.getCommentator().commentProliferation(this, true);
            return;
        }
        ...
        world.getCommentator().commentProliferation(this, false);
